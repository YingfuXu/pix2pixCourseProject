...
model_name = 'netG_resnet_9blocks_epoch_80_80_lr_0002'
model_path = "./GPU_result/cGAN_depth_simplified_resnet/checkpoint/" + model_name + ".pth"
data_test_dir = "./depth_New_test_sample/"
