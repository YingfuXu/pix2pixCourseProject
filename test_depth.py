...
model_name = 'netG_resnet_9blocks_epoch_80_80_lr_0002' # 'netG_resnet_9blocks_epoch_80_80_lr_0002' netG_unet_256_epoch_80_80_lr_0002
model_path = "../pix2pixFiles/GPU_result/cGAN_depth_simplified_resnet/checkpoint/" + model_name + ".pth" # cGAN_depth_simplified_resnet cGAN_depth_simplified_unet
data_test_dir = "../datasets/SYNTHIA-SF-19/forCourseProject/test/" # test_new
test_set = Image_Dataset('test_set', target_img_size, data_test_dir, input_grayscale=True)
